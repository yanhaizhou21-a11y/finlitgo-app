    ...
    <div className="flex flex-col gap-12 max-w-5xl mx-auto py-8 font-inter">
      ...
      <div className="flex flex-col items-center text-center">
        <h1 className="text-5xl font-bold font-orbitron text-white mb-4">
          <span className="text-[var(--color-accent-green)]">FinLitGo</span>{" "}
          Knowledge Base
        </h1>
      ...
      >
        <div className="w-full md:w-1/2 h-64 md:h-full overflow-hidden relative">
          ...
          />
          <div className="absolute top-6 left-6 bg-[var(--color-accent-green)] text-black font-bold uppercase tracking-wider text-xs px-3 py-1 rounded-full border border-lime-400 shadow-lg">
            Featured
          </div>
        </div>
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <span className="text-[var(--color-accent-green)] font-mono text-sm uppercase mb-3">
            {posts[0].category}
          </span>
          <h2 className="text-3xl font-bold text-white mb-4 leading-tight group-hover:text-[var(--color-accent-green)] transition-colors">
            {posts[0].title}
          </h2>
      ...
      {/* Recent Posts Grid */}
      <div>
        <h3 className="text-2xl font-bold font-orbitron mb-8 border-b border-zinc-800 pb-4">
          Recent Articles
        </h3>
          ...
          {posts.slice(1).map((post, i) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                <span className="text-[var(--color-accent-green)] font-mono tracking-widest text-[10px] uppercase mb-2 block">
                  {post.category}
                </span>
                <h4 className="text-xl font-bold text-white mb-3 group-hover:text-[var(--color-accent-green)] transition-colors leading-tight">
                  {post.title}
                </h4>
