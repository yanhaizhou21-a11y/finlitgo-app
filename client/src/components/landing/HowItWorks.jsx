    ...
    <section className="w-full bg-transparent py-24 px-6 md:px-12 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full">
        {steps.map((step, idx) => (
          <div 
            key={idx} 
            className="bg-white rounded-3xl p-8 flex flex-col items-center text-center shadow-lg transform transition duration-300 hover:-translate-y-1 hover:shadow-2xl"
          >
