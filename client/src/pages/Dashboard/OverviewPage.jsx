    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <div className="flex-1 sm:flex-none flex bg-white dark:bg-[#1E1E1E] px-3 sm:px-4 py-2 rounded-xl items-center gap-2 sm:gap-3 border border-zinc-200 dark:border-zinc-800 shadow-md dark:shadow-lg">
            <IconFlame size={24} className="text-orange-500 animate-pulse shrink-0" />
            <div className="flex flex-col">
              <span className="text-base sm:text-lg font-bold font-orbitron text-zinc-900 dark:text-white">{streakCount}</span>
          ...
          <div className="flex-1 sm:flex-none flex bg-white dark:bg-[#1E1E1E] px-3 sm:px-4 py-2 rounded-xl items-center gap-2 sm:gap-3 border border-zinc-200 dark:border-zinc-800 shadow-md dark:shadow-lg">
            ...
            <div className="flex flex-col">
              <span className="text-base sm:text-lg font-bold font-orbitron text-zinc-900 dark:text-white">{points}</span>
          ...
          {myClasses.map((cls, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-5 flex-1 z-10">
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center font-bold text-sm border transition-all duration-500 group-hover:scale-105 ${cls.progress === 100
              ...
              <div className="w-full md:w-48 mt-4 md:mt-0 z-10">
                ...
                <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-800/80 rounded-full overflow-hidden border border-zinc-300 dark:border-zinc-700/30">
                  <motion.div
                    ...
                    className={`h-full rounded-full shadow-[0_0_10px_rgba(0,0,0,0.5)] ${cls.progress === 100
